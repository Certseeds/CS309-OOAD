...
public class A5Test {
    ...
    @Test
    public void check_range_class() throws Exception {Class.forName("range");}

    @Test
    public void check_Price_class() throws Exception {
        Class<?> priceClass = Class.forName("Price");
        Assertions.assertTrue(Modifier.isAbstract(priceClass.getModifiers()));
    }
    ...
    public void check_Price_subclass() throws Exception {
        ...
        Assertions.assertTrue(priceClass.isAssignableFrom(childrensPriceClass));
        Assertions.assertTrue(priceClass.isAssignableFrom(newReleasePriceClass));
        Assertions.assertTrue(priceClass.isAssignableFrom(regularPriceClass));
    }
    ...
    public void check_Price_abstractMethods() throws Exception {
        ...
        Assertions.assertTrue(Modifier.isAbstract(getPriceCodeMethod.getModifiers()));
        args = new Class[1];
        args[0] = int.class;
        Method amountForMethod = priceClass.getDeclaredMethod("amountFor", args);
        Assertions.assertTrue(Modifier.isAbstract(amountForMethod.getModifiers()));
    }
    ...
    @Test
    public void test_Movie_amountFor() throws Exception{
        Class<?> movieClass = Class.forName("Movie");
        Class<?>[] args = new Class[1];
        args[0] = int.class;
        movieClass.getDeclaredMethod("amountFor", args);
        assertEquals(3, M1.amountFor(1), 0.00001);
        assertEquals(15, M1.amountFor(5), 0.00001);
        assertEquals(2, M2.amountFor(1), 0.00001);
        assertEquals(6.5, M2.amountFor(5), 0.00001);
        assertEquals(1.5, M3.amountFor(1), 0.00001);
        assertEquals(4.5, M3.amountFor(5), 0.00001);
    }
    ...
    @Test
    public void test_Rental_amountFor() throws Exception {
        Class<?> rentalClass = Class.forName("Rental");
        Class<?>[] args = new Class[0];
        rentalClass.getDeclaredMethod("amountFor", args);
        Date start = new Date(2013, 7, 1);
        Date end1 = new Date(2013, 7, 9);
        Date end2 = new Date(2013, 7, 11);
        Date end3 = new Date(2013, 7, 15);
        Rental r1 = new Rental(M1, new range(start, end1));
        Rental r2 = new Rental(M2, new range(start, end2));
        Rental r3 = new Rental(M3, new range(start, end3));
        assertEquals(24, r1.amountFor(), 0.00001);
        assertEquals(14, r2.amountFor(), 0.00001);
        assertEquals(18, r3.amountFor(), 0.00001);
    }
    ...
    public void test_Rental_getFrequentRenterPoints() throws Exception {
        ...
        assertEquals(1, new Rental(M1, new range(start, end1)).getFrequentRenterPoints());
        assertEquals(2, new Rental(M1, new range(start, end3)).getFrequentRenterPoints());
        assertEquals(1, new Rental(M2, new range(start, end1)).getFrequentRenterPoints());
        assertEquals(1, new Rental(M2, new range(start, end2)).getFrequentRenterPoints());
        assertEquals(1, new Rental(M3, new range(start, end1)).getFrequentRenterPoints());
        assertEquals(1, new Rental(M3, new range(start, end3)).getFrequentRenterPoints());
    }
    ...
    public void testMovieRental1() {
        ...
        Assertions.assertTrue(ans.equals(C1.statement()));
    }
    ...
    public void testMovieRental2() {
        ...
        String ans = ans1.toString();
        Assertions.assertTrue(ans.equals(C2.statement()));
    }
    ...
    public void testMovieRental3() {
        ...
        ans1.append("You earned 2 frequent renter points");
        String ans = ans1.toString();
        Assertions.assertTrue(ans.equals(C3.statement()));
    }
}
