	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				switch (op) {
				case 1:
					staffList.add(itsf.createITStaff(ITStaffEnum.ITManager));
					break;
				case 2:
					staffList.add(itsf.createITStaff(ITStaffEnum.Developer));
					break;
				case 3:
					staffList.add(itsf.createITStaff(ITStaffEnum.Tester));
					break;
				case 4:
